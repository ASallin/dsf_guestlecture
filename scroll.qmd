---
title: "The Impact of Choosing Wisely™ Recommendations and Insurance Coverage Restrictions on Low-Value Care: An Interrupted Time Series Analysis of Vitamin D Tests"
...
::: {.banner}
![](img/vitd-banner.jpg){.banner-image}

::: {.banner-overlay}
# Swiss Healthcare Policy in Action
## Tracking the Impact of Evidence-Based Interventions on Low-Value Care
:::
:::
...
This research has been published in BMC Health Services Research [@sallin2025impact].
...
We conduct statistical tests to see whether the recommendation led to a recognizable pattern. **We find The number of tests per consultation falls by 4.9% [-5.3%, -4.5%] after the recommendation.**
...
Coverage restrictions deliver a **62% reduction** in testing rates—a dramatic drop compared to clinical recommendations alone.
