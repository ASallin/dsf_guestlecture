...
subtitle: "On roads travelled, unnecessary shots, and data "
...
- I wanted to understand stuff. I studied philosophy.

- I discovered econometrics and causal inference. It fascinated me.

- I liked modelling data and use it to guide policy making. R & Applied Econ was for me.
...
#### I never really planned a career. I just followed what I found fascinating.

::: {.notes}
I was always unsure about what I wanted to do in my life, only that I wanted to understand stuff.

I started philosophy. Had lots of fun. Got lost in models of moral decision making. But it felt somehow disconnected.

What interested me were econometric applications to public finance, health and education economics.

:::


## PhD as 4 years of discovery
...
- During my MA, I was working as a student assistant and received great impulse.
...
::: {.notes}
By chance, I was working as a student assistant and I received great inpulse. This led me to find a PhD position in St. Gallen.
:::
...
- PhD done, I faced the choice: assistant professor in academia, or industry.
- I wanted to have impact on real-life decisions, develop leadership skills, and have fun.
- Now: **Senior Economist/Data Scientist** in the Health Services Management Team of SWICA.
...
::: {.notes}
After the PhD, I received offers to work as an assistant professor in academia. I wanted to keep my door open, so I also applied to industry. I did many interviews and had many offers. How I decided? The "état d'esprit" in the industry.

I landed a job at SWICA. There I do X and >.
...
- This is used for reimbursement.
- The way pricing is done creates incentives and (might) distort demand/supply.

::: {.notes}
This is the econ side of it.
:::
...
::: {.notes}
This is the data handling side of it.
:::
...
## What to do about low-value care?

::::: {.columns}
:::: {.column width="60%"}
::: {.fragment}
- **How can healthcare systems effectively reduce low-value care** that wastes millions in resources?
:::
...
- **Our Natural Experiment:** Switzerland tried two different approaches for Vitamin D tests:
    - Clinical guidelines
    - Financial restrictions

- **We study** what actually happened to prescription numbers
...
## The Problem: Vitamin D and Low-Value Care

::: {.incremental}

- **Vitamin D testing:** Prominent example of low-value care
  - Clinical guidelines consistently advise against routine testing for low-risk individuals
  - Yet testing rates continue to rise globally

\

- **Switzerland's situation**
  - Testing rates almost **doubled** between 2013-2020
  - From 96 to 199 tests per 1000 inhabitants
:::

::: {.notes}
Despite clear evidence that routine vitamin D testing provides little clinical value, its use has been increasing dramatically.
:::
...
- **Collaboration:**
    - Health services research team at SWICA
